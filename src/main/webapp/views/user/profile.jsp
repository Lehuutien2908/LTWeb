        ...
        <div class="col-md-9">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white py-3 border-bottom">
                    <h5 class="mb-0 fw-bold text-uppercase"><i class="bi bi-info-circle me-2 text-danger"></i> Hồ sơ cá nhân</h5>
                ...
                <div class="card-body p-4">
                    <form action="profile" method="post">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="phone" class="form-control" value="${user.phone}" placeholder="Cập nhật số điện thoại">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="address" class="form-control" value="${user.address}" placeholder="Cập nhật địa chỉ giao hàng">
                            </div>
                        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3 border-bottom">
                    <h5 class="mb-0 fw-bold text-uppercase"><i class="bi bi-clock-history me-2 text-danger"></i> Lịch sử mua hàng</h5>
                </div>
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="o" items="${orderHistory}">
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="d-inline-block text-truncate" style="max-width: 200px;" title="${o.listProductNames}">
                                                        ${o.listProductNames}
                                                    </span>
                                                </td>
